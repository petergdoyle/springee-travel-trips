...
public class FlightDetail implements Serializable {
    ...
    public String toString() {
        return "FlightDetail{" + "id=" + id + ", departureAirportCode=" + departureAirportCode + ", departureTime=" + departureTime + ", arrivalAirportCode=" + arrivalAirportCode + ", arrivalTime=" + arrivalTime + ", airline=" + airline + ", airlineCode=" + airlineCode + ", airlineFlightNumber=" + airlineFlightNumber + ", classOfService=" + classOfService + ", price=" + price + '}';
    }
}
