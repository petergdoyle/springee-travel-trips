...
public class AirSegment implements Serializable {
    ...
    public String toString() {
        return "AirSegment{" + "id=" + id + ", createDate=" + createDate + ", flightDetail=" + flightDetail + ", universalRecordId=" + universalRecordId + ", formOfPaymentList=" + formOfPaymentList + ", passengerDetailList=" + passengerDetailList + '}';
    }
}
