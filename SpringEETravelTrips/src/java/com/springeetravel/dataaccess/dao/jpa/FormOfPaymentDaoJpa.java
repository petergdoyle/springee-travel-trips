...
import com.springeetravel.dataaccess.dao.FormOfPaymentDao;
...
public class FormOfPaymentDaoJpa implements FormOfPaymentDao, Serializable {
    ...
    public List<FormOfPayment> find() {
        return findFormOfPaymentEntities(true, -1, -1);
    }

    public List<FormOfPayment> find(int maxResults, int firstResult) {
    ...
    public FormOfPayment find(Long id) {
